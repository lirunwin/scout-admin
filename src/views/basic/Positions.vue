        ...
        <v-card-text class="py-0">
          <v-container grid-list-md
            ...
            <v-layout row
              ...
              <v-flex xs12
                class="py-0">
                <v-select :items="topLevelPositions"
                  v-model="tag.pid"
                  item-text="label"
                  item-value="value"
                  label="父级"></v-select>
              ...
              <v-flex xs12
                ...
                <v-text-field name="name"
                  label="难度系数"
                  type="number"
                  v-model.number="tag.degree"></v-text-field>
              </v-flex>
              <v-flex xs12
                class="py-0">
                <v-text-field name="name"
...
export default {
  ...
  computed: {
    ...mapGetters(['positions', 'topLevelPositions']),
    availablePositions() {
      return this.positions.filter(tag => tag.status !== this.status.deprecated.value);
    },
    constant() {
    ...
    tableHeaders() {
      return this.constant.positionTableHeaders
    }
  },
  methods: {
    ...mapActions([
    ...
    toggleSelectAll() {
      ...
      else this.selectedTags = this.positions.slice()
    },
    search() {
  ...
  mounted() {
    ...
    //       sort: 12,
    //       name: `第二级${i}`,
    //       pid: '1529742609030534',
    //       degree: 2,
    //       recruitmenttype: 'RECRUITMENT_PARTTIME',
    //       status: 'DATA_NORMAL'
    //     })
    //   });
