  ...
  <v-container fluid>
    ...
    <v-container fluid class="py-0">
      <v-data-table
        ...
        :items="availableCommercialDistricts"
        no-data-text="未查询到数据..."
...
export default {
  ...
  computed: {
    ...mapGetters(['commercialDistricts']),
    availableCommercialDistricts() {
      return this.commercialDistricts.filter(tag => tag.status !== this.status.deprecated.value);
    },
    constant() {
    ...
    tableHeaders() {
      return this.constant.commercialDistrictTableHeaders
    }
  },
  methods: {
    ...mapActions([
      'getCommercialDistricts',
      'addOrUpdataCommercialDistrict',
      'updataCommercialDistrictStatus',
      'resetCommercialDistricts'
    ]),
    newTag() {
    ...
    saveTag(tag = this.tag) {
      ...
      this.addOrUpdataCommercialDistrict(tag)
        .then(() => {
          this.closeDialog();
    ...
    toggleSelectAll() {
      ...
      else this.selectedTags = this.commercialDistricts.slice()
    },
    search() {
    ...
    getData(params) {
      ...
      this.getCommercialDistricts(params)
